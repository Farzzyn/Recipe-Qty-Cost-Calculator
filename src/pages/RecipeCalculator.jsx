  ...
  return (
    ...
    <div className="max-w-6xl mx-auto pb-10 animate-fade-in print:hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        {/* Input Card */}
        <div className="glass-card rounded-2xl p-6 lg:col-span-1 border-purple-500/20 shadow-[0_0_20px_rgba(147,51,234,0.05)]">
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-slate-900/80 border border-purple-500/50 rounded-xl py-4 px-5 text-2xl font-bold text-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all shadow-inner"
        ...
        <div className="glass-card rounded-2xl p-6 lg:col-span-2 flex flex-col justify-center items-center text-center relative overflow-hidden">
          <div className="absolute top-[-50%] right-[-10%] w-64 h-64 bg-purple-600/10 rounded-full blur-[80px]" />
          
          <Receipt className="w-10 h-10 text-purple-500 mb-4 opacity-80" />
          ...
          <div className="mt-4 text-purple-400 font-medium bg-purple-500/10 px-4 py-1.5 rounded-full border border-purple-500/20 text-sm">
      ...
      <div className="glass-card rounded-2xl p-6 md:p-8">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-800 text-sm font-semibold text-slate-400 uppercase tracking-wider">
                ...
                <th className="py-4 px-4 text-right bg-[#E9D5FF] text-black rounded-tl-lg">Required Qty</th>
                <th className="py-4 px-4 text-right bg-[#E9D5FF] text-slate-800 rounded-tr-lg print:hidden">Est. Cost</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-800/50">
              {calculatedIngredients.map((ing, i) => (
                <tr key={ing.id || i} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="py-4 px-4 text-right bg-[#E9D5FF] font-black text-black text-lg">
                    {formatNumber(ing.displayScaledQty)} {ing.displayUnit}
                  </td>
                  <td className="py-4 px-4 text-right bg-[#E9D5FF] text-slate-800 font-medium print:hidden">
        ...
        <div className="flex gap-4 justify-center mt-6 pt-6 border-t border-slate-800 print:hidden">
          <button onClick={handlePrint} className="flex items-center gap-2 px-4 py-2 bg-purple-500/20 text-purple-400 rounded-lg hover:bg-purple-500/30 transition">
            <Printer className="w-4 h-4" /> Print
          </button>
          <button onClick={exportToCSV} className="flex items-center gap-2 px-4 py-2 bg-purple-500/20 text-purple-400 rounded-lg hover:bg-purple-500/30 transition">
